...
#print('imports done')
import spimLibraryX_0_2_5 as spim# version updated from Mike's spimLibrary, to add menu selections and stepsize options etc
t = 1 # time.sleep(1)
...
#    print ('   press a defined Key at any time to change function:')
    ...
    print(' 1st-> PRESS [2]  to run galvo NoScanfoucs v2 (to align beam)')
...
while SelectFunction != 'q':
    ...
    if SelectFunction =='4':
        ...
        #[SetOffset,SetFocus] = spim.ContinuousScan2(SetOffset, SetFocus, stepSize,  duration=10. , extent=0.500 , focusChannel="Dev1/ao2", scanChannel="Dev1/ao3")
        [SetOffset,SetFocus] = spim.ContinuousScan2(SetOffset, SetFocus, stepSize,  duration , extent , focusChannel="Dev1/ao2", scanChannel="Dev1/ao3")
