...
Version 0_3_0 Changes:
    - added new lines to interface for new key presses
    - interface now only displays noscanfocuys and scan for lightsheet'''
...
#print('imports done')
import spimLibraryX_0_3_0 as spim# version updated from Mike's spimLibrary, to add menu selections and stepSize options etc
t = 1 # time.sleep(1)
...
#    print ('   press a defined Key at any time to change function:')
    ...
    print(' 1st-> PRESS [1]  to run galvo NoScanfoucs v2 (to align beam)')
...
#    print('       PRESS [8]  to run galvo NoScanFocus2 v2 in DEBUG mode, ALL keys active ')
    ...
    print('        press [t] to reset offset and focus to zero')
    print('        press [y] to reset beam width' )
